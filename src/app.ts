...
app.post("/quest/battleStart", quest.battleStart);
app.post("/quest/battleContinue", quest.battleContinue);
app.post("/quest/battleFinish", quest.battleFinish);
app.post("/quest/saveBattleReplay", quest.saveBattleReplay);
app.post("/quest/getBattleReplay", quest.getBattleReplay);
app.post("/quest/changeSquadName", quest.changeSquadName);
app.post("/quest/squadFormation", quest.changeSquadFormation);
app.post("/quest/getAssistList", quest.getAssistList);
app.post("/storyreview/markStoryAcceKnown", quest.markStoryAcceKnown);
app.post("/storyreview/readStory", quest.readStory);
app.post("/act25side/battleStart", quest.battleStart);
app.post("/act25side/battleFinish", quest.battleFinish);
app.post("/car/confirmBattleCar", quest.changeBattleCar);
app.post("/templateTrap/setTrapSquad", quest.setTrapSquad);
app.post("/activity/act24side/battleStart", quest.battleStart);
app.post("/activity/act24side/battleFinish", quest.battleFinish);
app.post("/activity/act24side/setTool", quest.setTool);
app.post("/activity/bossRush/battleStart", quest.battleStart);
app.post("/activity/bossRush/battleFinish", quest.battleFinish);
app.post("/activity/bossRush/relicSelect", quest.relicSelect);
app.post("/retro/typeAct20side/competitionStart", quest.type20ActSideCompetitionStart);
app.post("/retro/typeAct20side/competitionFinish", quest.type20ActSideCompetitionFinish);
